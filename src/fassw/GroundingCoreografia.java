...
public class GroundingCoreografia {
    ...
    static File entrada = new File("servico20.wsdl");
    ...
    void gerar() throws IOException, InvalidModelException {
        ...
        //anexarVariante()
        servico.setWsmlVariant(org.wsmo.common.WSML.WSML_RULE);
        //END anexarVariante()    
        ...
        */
        ...
        Serializer serializer = Factory.createSerializer(new HashMap<String, Object>(0));
          serializer.serialize(new TopEntity[] {servico}, new PrintWriter(new File("servico.wsml"), "UTF-8"));
    }
    ...
    private void anexarVariante() {
        documentoWSML.append("wsmlVariant _" + VARIANTE_RULE);
    }
