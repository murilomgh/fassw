...
public class ForEachImpl implements ForEach,java.io.Serializable {
	...
	private Variable counterName;
	public Variable getCounterName() {
		return this.counterName;
	}
	public void setCounterName(Variable value) {
	...
	private CounterValue startCounterValue;
	public CounterValue getStartCounterValue() {
		return this.startCounterValue;
	}
	public void setStartCounterValue(CounterValue value) {
		this.startCounterValue=value;
	}

	private CounterValue finalCounterValue;
	public CounterValue getFinalCounterValue() {
		return this.finalCounterValue;
	}
	public void setFinalCounterValue(CounterValue value) {
