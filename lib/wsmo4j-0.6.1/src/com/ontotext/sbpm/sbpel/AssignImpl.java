...
public class AssignImpl implements Assign,java.io.Serializable {
	...
	private java.util.Set<AssignOperation> assignOperationSet = new java.util.HashSet<AssignOperation>();
	public boolean addAssignOperation(AssignOperation value) {
		return this.assignOperationSet.add(value);
	}
	public boolean removeAssignOperation(AssignOperation value) {
		return this.assignOperationSet.remove(value);
	}
	public java.util.Set<AssignOperation> listAssignOperations() {
		return new java.util.LinkedHashSet<AssignOperation>(this.assignOperationSet);
	}
	public java.util.Set<AssignOperation> getAssignOperationSet() {
		return this.assignOperationSet;
	}
	public void setAssignOperationSet(java.util.Set<AssignOperation> value) {
		this.assignOperationSet=value;
	}

}
/*
 * $Log: AssignImpl.java,v $
