...
public class FlowImpl implements Flow,java.io.Serializable {
	...
	private java.util.Set<Link> linkSet = new java.util.HashSet<Link>();
	public boolean addLink(Link value) {
		return this.linkSet.add(value);
	}
	public boolean removeLink(Link value) {
		return this.linkSet.remove(value);
	}
	public java.util.Set<Link> listLinks() {
		return new java.util.LinkedHashSet<Link>(this.linkSet);
	}
	public java.util.Set<Link> getLinkSet() {
		return this.linkSet;
	}
	public void setLinkSet(java.util.Set<Link> value) {
		this.linkSet=value;
	}

	private java.util.Set<Activity> activitySet = new java.util.HashSet<Activity>();
	public boolean addActivity(Activity value) {
		return this.activitySet.add(value);
	}
	public boolean removeActivity(Activity value) {
		return this.activitySet.remove(value);
	}
	public java.util.Set<Activity> listActivitys() {
		return new java.util.LinkedHashSet<Activity>(this.activitySet);
	}
	public java.util.Set<Activity> getActivitySet() {
		return this.activitySet;
	}
	public void setActivitySet(java.util.Set<Activity> value) {
