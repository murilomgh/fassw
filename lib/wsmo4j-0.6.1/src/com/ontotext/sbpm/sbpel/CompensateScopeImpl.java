...
public class CompensateScopeImpl implements CompensateScope,java.io.Serializable {
	...
	private Scope compensatesScope;
	public Scope getCompensatesScope() {
		return this.compensatesScope;
	}
	public void setCompensatesScope(Scope value) {
		this.compensatesScope=value;
	}

}
/*
 * $Log: CompensateScopeImpl.java,v $
