...
public class SemanticPickImpl implements SemanticPick,java.io.Serializable {
	...
	private java.util.Set<MessageEvent> onMessageSet = new java.util.HashSet<MessageEvent>();
	public boolean addOnMessage(MessageEvent value) {
		return this.onMessageSet.add(value);
	}
	public boolean removeOnMessage(MessageEvent value) {
		return this.onMessageSet.remove(value);
	}
	public java.util.Set<MessageEvent> listOnMessages() {
		return new java.util.LinkedHashSet<MessageEvent>(this.onMessageSet);
	}
	public java.util.Set<MessageEvent> getOnMessageSet() {
		return this.onMessageSet;
	}
	public void setOnMessageSet(java.util.Set<MessageEvent> value) {
