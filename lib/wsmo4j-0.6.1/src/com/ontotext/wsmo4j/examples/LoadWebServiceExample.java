...
public class LoadWebServiceExample {
    ...
    public static void showExample() throws InvalidModelException, ParserException {
        LoadWebServiceExample example = new LoadWebServiceExample();
        example.createFactoryParserSerializer();
        example.serializeParseWebService();
    }
    ...
    private void serializeParseWebService() throws InvalidModelException, ParserException {

        // create ontology to be serialzed
        WebService service = CreateWebServiceExample.showExample();

        try {
            // tries to serialize ontology with all its elements to a text
            StringWriter writer = new StringWriter();
            serializer.serialize(new TopEntity[] { service }, writer);
    ...
    public static void main(String[] args) throws InvalidModelException, ParserException {
        showExample();
    }
}

/*
 * $Log: LoadWebServiceExample.java,v $
