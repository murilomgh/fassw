...
public class ExtractionImpl extends DefinedByActionNodeImpl implements Extraction {

    public ExtractionImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof Extraction) {
            return false;
        }
