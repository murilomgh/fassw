...
public abstract class EventActionNodeImpl extends ActionNodeImpl implements EventActionNode {

    private Mode mode;
    private Concept concept;
    private Identifier partnerLink;

    public EventActionNodeImpl(Identifier id) {
        super(id);
    }
    ...
    public Identifier getPartnerLink() {
        return this.partnerLink;
    }

    public void setPartnerLink(Identifier id) {
        if (partnerLink == null) {
            throw new IllegalArgumentException();
        }
        this.partnerLink = id;
    ...
    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof EventActionNode) {
            return false;
        }
...
/*
 * $Log: EventActionNodeImpl.java,v $
