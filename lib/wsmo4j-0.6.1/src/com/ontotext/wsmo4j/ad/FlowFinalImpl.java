...
public class FlowFinalImpl extends EntityImpl implements FlowFinal {

    public FlowFinalImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof FlowFinal) {
            return false;
        }
