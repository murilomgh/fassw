...
public class ADChoreographyImpl extends EntityImpl implements ADChoreography {

    protected ActivityDiagram diagram;
    protected StateSignature ss;

    public ADChoreographyImpl(Identifier id) {
        super(id);
    }
...
/*
 * $Log: ADChoreographyImpl.java,v $
 * Revision 1.3  2007/05/14 12:34:14  lcekov
 * remove compilation errors in order to test continuum automatical build notication
 *
 * Revision 1.2  2007/05/14 12:30:15  lcekov
 * commit some compilation errors in order to test continuum automatical build notication
 *
