...
public class InterruptibleRegionImpl extends ActivityGroupImpl implements InterruptibleRegion {

    public InterruptibleRegionImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof InterruptibleRegion) {
            return false;
        }
...
/*
 * $Log: InterruptibleRegionImpl.java,v $
