...
public class DataFlowImpl extends ActivityEdgeImpl implements DataFlow {

    public DataFlowImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof DataFlow) {
            return false;
        }
