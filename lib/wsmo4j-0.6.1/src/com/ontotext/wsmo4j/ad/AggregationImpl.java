...
public class AggregationImpl extends DefinedByActionNodeImpl implements Aggregation {

    public AggregationImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof Aggregation) {
            return false;
        }
