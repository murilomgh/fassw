...
public class ReceiveEventActionImpl extends EventActionNodeImpl implements ReceiveEventAction {

    public ReceiveEventActionImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof ReceiveEventAction) {
            return false;
        }
...
/*
 * $Log: ReceiveEventActionImpl.java,v $
