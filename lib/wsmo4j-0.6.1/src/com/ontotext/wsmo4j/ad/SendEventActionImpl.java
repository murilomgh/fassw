...
public class SendEventActionImpl extends EventActionNodeImpl implements SendEventAction {

    public SendEventActionImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof SendEventAction) {
            return false;
        }
...
/*
 * $Log: SendEventActionImpl.java,v $
