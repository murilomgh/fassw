...
public class GeneralActionImpl extends ActionNodeImpl implements GeneralAction {

    public GeneralActionImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof GeneralAction) {
            return false;
        }
