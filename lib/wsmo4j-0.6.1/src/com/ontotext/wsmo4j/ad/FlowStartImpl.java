...
public class FlowStartImpl extends EntityImpl implements FlowStart {

    public FlowStartImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof FlowStart) {
            return false;
        }
