...
public class ActivityFinalImpl extends EntityImpl implements ActivityFinal {

    public ActivityFinalImpl(Identifier id) {
        super(id);
    }

    public boolean equals(Object obj) {
        if (obj == null
                || false == obj instanceof ActivityFinal) {
            return false;
        }
