...
public class WGMediatorImpl extends MediatorImpl
        implements WGMediator {

    public WGMediatorImpl(IRI mediatorIRI) {
        super(mediatorIRI);
    }
    
    public boolean equals(Object object) {
        if (object == null 
                || false == object instanceof WGMediator) {
            return false;
        }
 ...
 *
 * Revision 1.10  2005/06/01 12:07:31  marin_dimitrov
 * v0.4.0
 *
