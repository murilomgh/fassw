 ...
 */
public class InverseImplicationImpl
        extends BinaryImpl
        implements InverseImplication {

    public InverseImplicationImpl(LogicalExpression exprLeft, LogicalExpression exprRight)
            throws IllegalArgumentException {
        super(exprLeft, exprRight);
    }

    public void accept(Visitor v) {
        v.visitInverseImplication(this);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof InverseImplication) {
            InverseImplication b = (InverseImplication)o;
