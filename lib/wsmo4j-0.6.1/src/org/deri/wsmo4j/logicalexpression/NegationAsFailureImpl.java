 ...
 */
public class NegationAsFailureImpl
        extends UnaryImpl
        implements NegationAsFailure {

    public NegationAsFailureImpl(LogicalExpression expr)
            throws IllegalArgumentException {
        super(expr);
    }

    public void accept(Visitor v) {
        v.visitNegationAsFailure(this);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof NegationAsFailure) {
            NegationAsFailure u = (NegationAsFailure)o;
