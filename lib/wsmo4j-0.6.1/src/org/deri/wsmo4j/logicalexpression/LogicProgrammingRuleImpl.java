 ...
 */
public class LogicProgrammingRuleImpl
        extends BinaryImpl
        implements LogicProgrammingRule {

    public LogicProgrammingRuleImpl(LogicalExpression exprLeft, LogicalExpression exprRight)
            throws IllegalArgumentException {
        super(exprLeft, exprRight);
    }

    public void accept(Visitor v) {
        v.visitLogicProgrammingRule(this);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof LogicProgrammingRule) {
            LogicProgrammingRule b = (LogicProgrammingRule)o;
