 ...
 */
public class AttributeConstraintMoleculeImpl
        extends AttributeMoleculeImpl
        implements AttributeConstraintMolecule {

    public void accept(Visitor v) {
        v.visitAttributeContraintMolecule(this);
    }

    public AttributeConstraintMoleculeImpl(Term leftTerm, Term attributeName, Term rightTerm) {
    ...
    public boolean equals(Object o) {
        if (o instanceof AttributeConstraintMolecule) {
            AttributeConstraintMolecule as = (AttributeConstraintMolecule)o;
