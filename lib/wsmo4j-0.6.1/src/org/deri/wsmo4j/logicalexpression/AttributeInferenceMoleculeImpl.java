 ...
 */
public class AttributeInferenceMoleculeImpl
        extends AttributeMoleculeImpl
        implements AttributeInferenceMolecule {

    public AttributeInferenceMoleculeImpl(Term leftTerm, Term attributeName, Term rightTerm) {
        super(leftTerm,attributeName,rightTerm);
    }
    
    public void accept(Visitor v) {
        v.visitAttributeInferenceMolecule(this);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof AttributeInferenceMolecule) {
            AttributeInferenceMolecule as = (AttributeInferenceMolecule)o;
