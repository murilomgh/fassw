 ...
 *     $Source: /cvsroot/wsmo4j/ext/orchestration/src/ri/org/deri/wsmo4j/orchestration/rule/ForAllRI.java,v $
 * </pre>
 * 
 ...
 */
public class ForAllRI extends AbstractQuantifiedRuleRI implements OrchestrationForAll {
     ...
     */
    public ForAllRI(Variable variable, Condition condition, Rule rule) {
     ...
     *            Inner Rule of forall
     */
    public ForAllRI(Set<Variable> variables, Condition condition, Rule rule) {
     ...
     */
    public ForAllRI(Variable variable, Condition condition, Set<Rule> rules) {
     ...
     *            A set of inner Rule objects
     */
    public ForAllRI(Set<Variable> variables, Condition condition, Set<Rule> rules) {
    ...
    public void accept(Visitor visitor) {
        visitor.visitOrchestrationForAll(this);
    }
