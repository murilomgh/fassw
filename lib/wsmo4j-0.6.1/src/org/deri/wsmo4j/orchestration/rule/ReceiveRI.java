 ...
 *
 * $Source: /cvsroot/wsmo4j/ext/orchestration/src/ri/org/deri/wsmo4j/orchestration/rule/ReceiveRI.java,v $,
 * @version $Revision: 1.2 $ $Date: 2007/04/02 13:05:17 $
 */

public class ReceiveRI extends PerformRI implements Receive {

	private IRI source;
	
	public ReceiveRI(IRI performance, IRI source) {
		super(performance);
		this.source = source;
	}
