...
import org.wsmo.service.orchestration.rule.OrchestrationQuantifiedRule;
 ...
 *     $Source: /cvsroot/wsmo4j/ext/orchestration/src/ri/org/deri/wsmo4j/orchestration/rule/AbstractQuantifiedRuleRI.java,v $
 * </pre>
 * 
 * @author Thomas Haselwanter
 * @author James Scicluna
 * 
 * @version $Revision: 1.1 $ $Date: 2006/10/24 15:01:05 $
 */
public abstract class AbstractQuantifiedRuleRI extends AbstractTransitionRuleRI implements
     ...
     */
    public AbstractQuantifiedRuleRI(Set<Variable> variables, Condition condition, Set<Rule> rules) {
        super();
