 ...
 *      $Source: /cvsroot/wsmo4j/ext/choreography/src/ri/org/deri/wsmo4j/rule/AddRI.java,v $
 * </pre>
 * 
 ...
 */
public class AddRI extends AbstractUpdateRule implements Add {

    /**
     * @param fact
     *            A CompoundFact object defining the fact of the Add rule
     */
    public AddRI(CompoundFact fact) {
        super(fact);
    }
