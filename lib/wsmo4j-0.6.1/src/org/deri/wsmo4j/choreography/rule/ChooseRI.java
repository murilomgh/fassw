 ...
 *     $Source: /cvsroot/wsmo4j/ext/choreography/src/ri/org/deri/wsmo4j/choreography/rule/ChooseRI.java,v $
 * </pre>
 * 
 ...
 */
public class ChooseRI extends AbstractQuantifiedRuleRI implements ChoreographyChoose {
     ...
     */
    public ChooseRI(Variable variable, Condition condition, ChoreographyRule rule) {
     ...
     *            Inner Rule of choose
     */
    public ChooseRI(Set<Variable> variables, Condition condition, ChoreographyRule rule) {
     ...
     */
    public ChooseRI(Variable variable, Condition condition, Set<ChoreographyRule> rules) {
     ...
     *            A set of inner Rule objects
     */
    public ChooseRI(Set<Variable> variables, Condition condition, Set<ChoreographyRule> rules) {
    ...
    public void accept(Visitor visitor) {
        visitor.visitChoreographyChoose(this);
    }
