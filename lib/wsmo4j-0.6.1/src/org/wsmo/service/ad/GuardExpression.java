...
public interface GuardExpression extends Guard {
    ...
    /**
     */
    public abstract LogicalExpression getLogicalExpression();

    /**
     */
    public abstract void setLogicalExpression(LogicalExpression le);

}

/*
 * $Log: GuardExpression.java,v $
 * Revision 1.1  2006/12/08 17:11:09  vassil_momtchev
