...
public interface DefinedByActionNode extends ActionNode {

    /**
     */
    public abstract Identifier getDefinedBy();

    /**
     */
    public abstract void setDefinedBy(Identifier id);

}

/*
 * $Log: DefinedByActionNode.java,v $
