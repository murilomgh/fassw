...
public interface ActivityDiagram {
    ...
    /**
     */
    public abstract void setActivityGroup(ActivityGroup group);

    /**
     */
    public abstract ActivityNode getStartNode();

    /**
     */
    public abstract void setStartNode(ActivityNode node);

}

/*
 * $Log: ActivityDiagram.java,v $
