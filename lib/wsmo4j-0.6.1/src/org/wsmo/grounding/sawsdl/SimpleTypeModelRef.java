...
import org.wsmo.grounding.sawsdl.TypeModelRef;

/**
 * Representation of a single annotation reference from an XML Schema simpleType definition
 * to a concept of a semantic model.
 * For details see: <br>
 ...
 */
public interface SimpleTypeModelRef extends TypeModelRef {

}

/*
 * $Log: SimpleTypeModelRef.java,v $
